...
class myDataloader_cholec(object):
    def __init__(self, OLG=False,img_size = 128,Display_loading_video = False, 
                 Read_from_pkl= True,Save_pkl = False,Load_flow =False, Device=device, gt_mask_dir=None):
                ...
                if clip_name in self.gt_mask_files:
                    try:
                        ...
                        if mask_data is not None:
                            masks = mask_data  # Assuming the pkl file directly contains the mask array

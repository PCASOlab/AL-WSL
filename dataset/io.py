...
class NumpyModuleRedirectUnpickler(pickle.Unpickler):
    """Redirect old numpy._core module paths to numpy.core"""
...
def read_a_pkl(dir, name):
    """Read a pickle file with module redirection for numpy compatibility"""
    filepath = os.path.join(dir, name + '.pkl')
    with open(filepath, 'rb') as f:
        return NumpyModuleRedirectUnpickler(f, encoding='iso-8859-1').load()

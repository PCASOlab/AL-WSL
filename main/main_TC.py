...
Output_root = Output_root+ "temporal_consistent/" +selected_data +'para1/'
...
Model_infer = model_infer_TC._Model_infer(GPU_mode,num_gpus,Enable_teacher=True,gpu_selection="0",pooling="max",TPC=True)
...
if Continue_flag == False:
    ...
    Model_infer.VideoNets.load_state_dict(torch.load(Output_root + 'outNets' + loadmodel_index ),strict=True )
    Model_infer.VideoNets_S.load_state_dict(torch.load(Output_root + 'outNets_s' + loadmodel_index ),strict=True )

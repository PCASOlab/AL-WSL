...
import torch.utils.data
from torch.autograd import Variable
from model import  model_experiement, model_infer,model_infer_TC2
...
Output_root = Output_root+ "temporal_consistent/" +selected_data +'para2/'
...
Model_infer = model_infer_TC2._Model_infer(GPU_mode,num_gpus,Enable_teacher=True,gpu_selection="0",pooling="max",TPC=True)

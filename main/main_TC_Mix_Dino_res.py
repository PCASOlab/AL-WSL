...
import torch.utils.data
from torch.autograd import Variable
from model import  model_experiement, model_infer,model_infer_TC_mix_dino_res
...
Output_root = Output_root+ "temporal_consistent/" +selected_data +"mix"+'/'
...
Model_infer = model_infer_TC_mix_dino_res._Model_infer(GPU_mode,num_gpus,Enable_teacher=True,gpu_selection="0",pooling="rank",TPC=True)

...
import torch.utils.data
from torch.autograd import Variable
from model import  model_experiement, model_infer,model_infer_feature_com
...
Model_infer = model_infer_feature_com._Model_infer(GPU_mode,num_gpus,Enable_teacher=True,gpu_selection="0",pooling="max",TPC=True)

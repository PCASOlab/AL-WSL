...
Output_root = Output_root+ "temporal_consistent_maxpool/"
...
Model_infer = model_infer_TC._Model_infer(GPU_mode,num_gpus,Enable_teacher=True,gpu_selection="0",pooling="max")

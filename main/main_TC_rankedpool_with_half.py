...
Output_root = Output_root+ "temporal_consistent_rankpool_with_half/"
...
Model_infer = model_infer_TC._Model_infer(GPU_mode,num_gpus,Enable_teacher=True,gpu_selection="0",pooling="rank")

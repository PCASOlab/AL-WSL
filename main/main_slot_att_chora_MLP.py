...
DEFAULT_CONFIG = "videosaur_m/configs/videosaur/ytvis3_MLP.yml"
...
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),GPU_mode,num_gpus,Enable_teacher=True,gpu_selection="0",pooling="max",TPC=True)

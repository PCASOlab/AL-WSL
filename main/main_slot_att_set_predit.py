...
from working_dir_root import Enable_student,Batch_size,selected_data
...
Output_root = Output_root+ "Obj_centric_set_pred" + selected_data + "/"
...
DEFAULT_CONFIG = "videosaur_m/configs/videosaur/ytvis.yml"
...
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),GPU_mode,num_gpus,Enable_teacher=True,gpu_selection="all",pooling="max",TPC=True)
...
if Continue_flag == False:
    pass
    # Model_infer.model.initializer.apply(weights_init)
    # Model_infer.model.processor.apply(weights_init)
    # Model_infer.model.decoder.apply(weights_init)

...
def get_debug_params():
    return {
        ...
        'weight': '/data/slot_difusion/savi_ldm_movid_params-res128.pth',  # Optional: path to weights for loading
...
if __name__ == "__main__":
    ...
    task = importlib.import_module(f"SlotDiffusion_m.slotdiffusion.{args['task']}")
    ...
    sys.path.append("SlotDiffusion_m/"+os.path.dirname(args['params']))

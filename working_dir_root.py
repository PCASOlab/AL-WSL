...
MACHINE_ID = 2 # Or 3 1: pcasolab1 2: pcasolab2 3: pcasolab3 4: pcasolab4 5: pcasolab5 6: pcasolab6 7: pcasolab7 8: pcasolab8 9: pcasolab9 10: pcasolab10
...
import_mode = os.environ.get('WORKING_DIR_IMPORT_MODE', 'train_poem')
...
if import_mode == 'train_cholec':
    ...
    from working_para.working_dir_root_eval_cholec_p import *
...
elif import_mode == 'eval_poem':
    from working_para.working_dir_root_eval_poem_p import *

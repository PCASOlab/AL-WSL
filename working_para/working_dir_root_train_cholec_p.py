...
if selected_data == "Cholec_data_flag":
    sam_feature_OLG_dir= working_pcaso_raid+ "cholec_sam_feature_OLG2/"
...
#false to restart training from scratch, true to continue training from where you ended
# Continue_flag = False
Continue_flag = True
...
Load_feature = True  # remember switch feature path
...
Categories_json = os.path.join(Davis_root, 'categories.json')
